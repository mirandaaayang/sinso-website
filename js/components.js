    ...
    <div class="footer-main">
      ...
      <div>
        ...
        <div class="footer-social">
          ...
          <a href="#wechat" class="social-link wechat-trigger" aria-label="WeChat" title="微信：扫码关注 sinsoprinting">
        ...
        <!-- WeChat QR tooltip -->
        <div class="wechat-qr-note" data-lang="en" style="margin-top:10px;font-size:0.75rem;color:rgba(255,255,255,0.3);">
          WeChat: scan QR or search <strong style="color:rgba(255,255,255,0.5);">sinsoprinting</strong>
        </div>
        <div class="wechat-qr-note" data-lang="zh" style="margin-top:10px;font-size:0.75rem;color:rgba(255,255,255,0.3);">
          微信：扫码或搜索 <strong style="color:rgba(255,255,255,0.5);">sinsoprinting</strong>
        </div>
      </div>
